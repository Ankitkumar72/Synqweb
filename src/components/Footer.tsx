        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-16 mb-24">
          <div className="col-span-2 lg:col-span-2 space-y-8">
            ...
            <div className="flex gap-4">
              {/* X */}
              <Link href="https://x.com/SynqApp_" className="group w-12 h-12 bg-white border border-black/5 rounded-full flex items-center justify-center hover:bg-black hover:border-black hover:scale-110 transition-all duration-300 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
